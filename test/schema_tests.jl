...
@testset "schema" begin
    ...
    bad[1] = ColumnDesc(bad[1].name, bad[1].comment, bad[1].manager,
                        bad[1].group, MSv2.TpInt, bad[1].shape, bad[1].option,
                        bad[1].maxlength, bad[1].keywords, bad[1].default,
                        bad[1].sequ)                              # wrong type
    bt = MSv2.CTDSTable(t.path, t.type, t.subtype, t.readme, t.version, t.rows,
